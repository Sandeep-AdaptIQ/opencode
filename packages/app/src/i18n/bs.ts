export const dict = {
  ...
  "dialog.provider.App.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.App.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.AppGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje App",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u App-u.",
  ...
  "provider.connect.AppZen.visit.prefix": "Posjeti ",
  "provider.connect.AppZen.visit.link": "#",
  "provider.connect.AppZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u App-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u App-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u App.json",
  ...
  "dialog.server.description": "Promijeni na koji se App server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingApp": "Provjera App...",
  "wsl.onboarding.checkingAppIn": "Provjera App u distribuciji {{distro}}...",
  "wsl.onboarding.updatingApp": "Ažuriranje App...",
  "wsl.onboarding.updatingAppIn": "Ažuriranje App u distribuciji {{distro}}...",
  "wsl.onboarding.updateAppIn": "Ažuriraj App u distribuciji {{distro}}.",
  "wsl.onboarding.updateApp": "Ažuriraj App",
  "wsl.onboarding.AppReadyIn": "App je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.AppReady": "App je spreman.",
  "wsl.onboarding.installAppIn": "Instaliraj App u distribuciji {{distro}}.",
  "wsl.onboarding.installApp": "Instaliraj App",
  ...
  "wsl.onboarding.distroStatus.AppMissing": "App nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi App mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "App nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori App.",
  ...
  "toast.update.description": "Nova verzija App-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku App timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (App.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: App još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "App uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni App server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u App-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako App izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li App prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu App-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se App pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju App-a.",
