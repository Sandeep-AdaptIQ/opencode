...
export const dict = {
  ...
  "dialog.provider.App.note": "使用 Zen 或 API 密钥连接",
  "dialog.provider.App.tagline": "可靠的优化模型",
  "dialog.provider.AppGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "App 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 App 中使用 {{provider}} 模型。",
  ...
  "provider.connect.AppZen.line1": "Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.AppZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.AppZen.visit.prefix": "访问 ",
  "provider.connect.AppZen.visit.link": "#",
  "provider.connect.AppZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 App 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 App 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 App.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 App 服务器。",
  ...
  "wsl.onboarding.checkingApp": "正在检查 App...",
  "wsl.onboarding.checkingAppIn": "正在检查 {{distro}} 中的 App...",
  "wsl.onboarding.updatingApp": "正在更新 App...",
  "wsl.onboarding.updatingAppIn": "正在更新 {{distro}} 中的 App...",
  "wsl.onboarding.updateAppIn": "更新 {{distro}} 中的 App。",
  "wsl.onboarding.updateApp": "更新 App",
  "wsl.onboarding.AppReadyIn": "{{distro}} 中的 App 已就绪。",
  "wsl.onboarding.AppReady": "App 已就绪。",
  "wsl.onboarding.installAppIn": "在 {{distro}} 中安装 App。",
  "wsl.onboarding.installApp": "安装 App",
  ...
  "wsl.onboarding.distroStatus.AppMissing": "未安装 App",
  ...
  "wsl.onboarding.wslNotInstalled.description": "App 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "App 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 App。",
  ...
  "toast.update.description": "App 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 App 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (App.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: App 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "App 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 App 服务器。",
  ...
  "settings.general.row.language.description": "更改 App 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 App 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 App 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 App 的主题。",
  ...
  "settings.updates.row.startup.description": "在 App 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 App。",
