...
export const dict = {
  ...
  "dialog.provider.App.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.App.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.AppGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "App tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve App'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.AppZen.visit.prefix": "",
  "provider.connect.AppZen.visit.link": "#",
  "provider.connect.AppZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak App'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak App'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler App.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi App sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingApp": "App kontrol ediliyor...",
  "wsl.onboarding.checkingAppIn": "{{distro}} içinde App kontrol ediliyor...",
  "wsl.onboarding.updatingApp": "App güncelleniyor...",
  "wsl.onboarding.updatingAppIn": "{{distro}} içinde App güncelleniyor...",
  "wsl.onboarding.updateAppIn": "{{distro}} içindeki App'u güncelleyin.",
  "wsl.onboarding.updateApp": "App'u güncelle",
  "wsl.onboarding.AppReadyIn": "{{distro}} içinde App hazır.",
  "wsl.onboarding.AppReady": "App hazır.",
  "wsl.onboarding.installAppIn": "App'u {{distro}} içine kurun.",
  "wsl.onboarding.installApp": "App'u kur",
  ...
  "wsl.onboarding.distroStatus.AppMissing": "App kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "App'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "App bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından App'u tekrar açın.",
  ...
  "toast.update.description": "App'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı App ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (App.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: App henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "App ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "settings.desktop.wsl.description": "App sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "App'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "App'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "App'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "App'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "App başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "App'un en son sürümünü kullanıyorsunuz.",
