export const dict = {
  ...
  "dialog.provider.App.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.App.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.AppGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Appが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Appで{{provider}}モデルを使用します。",
  ...
  "provider.connect.AppZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.AppZen.visit.prefix": " ",
  "provider.connect.AppZen.visit.link": "#",
  "provider.connect.AppZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してAppで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Appで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "App.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するAppサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingApp": "Appを確認中...",
  "wsl.onboarding.checkingAppIn": "{{distro}}内のAppを確認中...",
  "wsl.onboarding.updatingApp": "Appを更新中...",
  "wsl.onboarding.updatingAppIn": "{{distro}}内のAppを更新中...",
  "wsl.onboarding.updateAppIn": "{{distro}}内のAppを更新してください。",
  "wsl.onboarding.updateApp": "Appを更新",
  "wsl.onboarding.AppReadyIn": "{{distro}}内のAppの準備ができました。",
  "wsl.onboarding.AppReady": "Appの準備ができました。",
  "wsl.onboarding.installAppIn": "{{distro}}にAppをインストールしてください。",
  "wsl.onboarding.installApp": "Appをインストール",
  ...
  "wsl.onboarding.distroStatus.AppMissing": "Appがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AppでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Appをもう一度開いてください。",
  ...
  "toast.update.description": "Appの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをAppチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (App.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: AppはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Appには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でAppサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Appの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのAppの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Appがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Appのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "App の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "App は最新バージョンです。",
