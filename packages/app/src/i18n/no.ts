...
export const dict = {
  ...
  "dialog.provider.App.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.App.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.AppGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av App",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i App.",
  ...
  "provider.connect.AppZen.visit.prefix": "Besøk ",
  "provider.connect.AppZen.visit.link": "#",
  "provider.connect.AppZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i App.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i App.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i App.json",
  ...
  "dialog.server.description": "Bytt hvilken App-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av App ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til App-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (App.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at App ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "App inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør App-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for App",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan App ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om App skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan App er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når App starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av App.",
  ...
  "wsl.onboarding.checkingApp": "Sjekker App...",
  "wsl.onboarding.checkingAppIn": "Sjekker App i {{distro}}...",
  "wsl.onboarding.updatingApp": "Oppdaterer App...",
  "wsl.onboarding.updatingAppIn": "Oppdaterer App i {{distro}}...",
  "wsl.onboarding.updateAppIn": "Oppdater App i {{distro}}.",
  "wsl.onboarding.updateApp": "Oppdater App",
  "wsl.onboarding.AppReadyIn": "App er klar i {{distro}}.",
  "wsl.onboarding.AppReady": "App er klar.",
  "wsl.onboarding.installAppIn": "Installer App i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.AppMissing": "App er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før App kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "App kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter App på nytt.",
