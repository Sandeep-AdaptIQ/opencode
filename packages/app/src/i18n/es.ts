export const dict = {
  ...
  "dialog.provider.App.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.App.tagline": "Modelos optimizados y fiables",
  "dialog.provider.AppGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por App",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en App.",
  ...
  "provider.connect.AppZen.visit.prefix": "Visita ",
  "provider.connect.AppZen.visit.link": "#",
  "provider.connect.AppZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en App.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en App.",
  ...
  "dialog.plugins.empty": "Plugins configurados en App.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de App se conecta esta app.",
  ...
  "wsl.onboarding.checkingApp": "Comprobando App...",
  "wsl.onboarding.checkingAppIn": "Comprobando App en {{distro}}...",
  "wsl.onboarding.updatingApp": "Actualizando App...",
  "wsl.onboarding.updatingAppIn": "Actualizando App en {{distro}}...",
  "wsl.onboarding.updateAppIn": "Actualiza App en {{distro}}.",
  "wsl.onboarding.updateApp": "Actualizar App",
  "wsl.onboarding.AppReadyIn": "App está listo en {{distro}}.",
  "wsl.onboarding.AppReady": "App está listo.",
  "wsl.onboarding.installAppIn": "Instala App en {{distro}}.",
  "wsl.onboarding.installApp": "Instalar App",
  ...
  "wsl.onboarding.distroStatus.AppMissing": "App no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que App pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "App no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir App.",
  ...
  "toast.update.description": "Una nueva versión de App ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de App",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (App.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, App no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "App incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor App dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para App",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve App en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si App sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de App.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia App",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de App.",
