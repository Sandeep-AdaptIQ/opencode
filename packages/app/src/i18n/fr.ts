export const dict = {
  ...
  "dialog.provider.App.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.App.tagline": "Modèles optimisés et fiables",
  "dialog.provider.AppGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par App",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans App.",
  ...
  "provider.connect.AppZen.visit.prefix": "Visitez ",
  "provider.connect.AppZen.visit.link": "#",
  "provider.connect.AppZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans App.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans App.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans App.json",
  ...
  "dialog.server.description": "Changez le serveur App auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingApp": "Vérification d'App...",
  "wsl.onboarding.checkingAppIn": "Vérification d'App dans {{distro}}...",
  "wsl.onboarding.updatingApp": "Mise à jour d'App...",
  "wsl.onboarding.updatingAppIn": "Mise à jour d'App dans {{distro}}...",
  "wsl.onboarding.updateAppIn": "Mettez à jour App dans {{distro}}.",
  "wsl.onboarding.updateApp": "Mettre à jour App",
  "wsl.onboarding.AppReadyIn": "App est prêt dans {{distro}}.",
  "wsl.onboarding.AppReady": "App est prêt.",
  "wsl.onboarding.installAppIn": "Installez App dans {{distro}}.",
  "wsl.onboarding.installApp": "Installer App",
  ...
  "wsl.onboarding.distroStatus.AppMissing": "App non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'App puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "App n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez App.",
  ...
  "toast.update.description":
    "Une nouvelle version d'App ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe App",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (App.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'App ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "App inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur App dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour App",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'App sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si App suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'App.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'App",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'App.",
