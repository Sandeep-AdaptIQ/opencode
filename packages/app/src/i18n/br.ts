export const dict = {
  ...
  "dialog.provider.App.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.App.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.AppGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo App",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no App.",
  ...
  "provider.connect.AppZen.visit.prefix": "Visite ",
  "provider.connect.AppZen.visit.link": "#",
  "provider.connect.AppZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no App.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no App.",
  ...
  "dialog.plugins.empty": "Plugins configurados em App.json",
  ...
  "dialog.server.description": "Trocar para qual servidor App este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingApp": "Verificando o App...",
  "wsl.onboarding.checkingAppIn": "Verificando o App em {{distro}}...",
  "wsl.onboarding.updatingApp": "Atualizando o App...",
  "wsl.onboarding.updatingAppIn": "Atualizando o App em {{distro}}...",
  "wsl.onboarding.updateAppIn": "Atualize o App em {{distro}}.",
  "wsl.onboarding.updateApp": "Atualizar o App",
  "wsl.onboarding.AppReadyIn": "O App está pronto em {{distro}}.",
  "wsl.onboarding.AppReady": "O App está pronto.",
  "wsl.onboarding.installAppIn": "Instale o App em {{distro}}.",
  "wsl.onboarding.installApp": "Instalar o App",
  ...
  "wsl.onboarding.distroStatus.AppMissing": "App não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o App possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O App não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o App novamente.",
  ...
  "toast.update.description": "Uma nova versão do App ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do App",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (App.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: App ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "App inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor App dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do App",
  ...
  "settings.general.row.appearance.description": "Personalize como o App aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o App segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o App é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o App iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do App.",
