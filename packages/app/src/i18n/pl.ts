export const dict = {
  ...
  "dialog.provider.App.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.App.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.AppGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez App",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w App.",
  ...
  "provider.connect.AppZen.visit.prefix": "Odwiedź ",
  "provider.connect.AppZen.visit.link": "#",
  "provider.connect.AppZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w App.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w App.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w App.json",
  ...
  "dialog.server.description": "Przełącz serwer App, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingApp": "Sprawdzanie App...",
  "wsl.onboarding.checkingAppIn": "Sprawdzanie App w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingApp": "Aktualizowanie App...",
  "wsl.onboarding.updatingAppIn": "Aktualizowanie App w dystrybucji {{distro}}...",
  "wsl.onboarding.updateAppIn": "Zaktualizuj App w dystrybucji {{distro}}.",
  "wsl.onboarding.updateApp": "Zaktualizuj App",
  "wsl.onboarding.AppReadyIn": "App jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.AppReady": "App jest gotowy.",
  "wsl.onboarding.installAppIn": "Zainstaluj App w dystrybucji {{distro}}.",
  "wsl.onboarding.installApp": "Zainstaluj App",
  ...
  "wsl.onboarding.distroStatus.AppMissing": "App nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim App będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "App nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz App.",
  ...
  "toast.update.description": "Nowa wersja App ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu App",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (App.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: App nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "App zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer App wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla App",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd App na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy App ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw App.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania App",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji App.",
