...
export const dict = {
  ...
  "dialog.provider.App.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.App.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.AppGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von App",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in App zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in App zu nutzen.",
  ...
  "dialog.plugins.empty": "In App.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den App-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingApp": "App wird geprüft...",
  "wsl.onboarding.checkingAppIn": "App in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingApp": "App wird aktualisiert...",
  "wsl.onboarding.updatingAppIn": "App in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateAppIn": "Aktualisieren Sie App in {{distro}}.",
  "wsl.onboarding.updateApp": "App aktualisieren",
  "wsl.onboarding.AppReadyIn": "App ist in {{distro}} bereit.",
  "wsl.onboarding.AppReady": "App ist bereit.",
  "wsl.onboarding.installAppIn": "Installieren Sie App in {{distro}}.",
  "wsl.onboarding.installApp": "App installieren",
  ...
  "wsl.onboarding.distroStatus.AppMissing": "App nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor App einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "App konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann App erneut.",
  ...
  "toast.update.description": "Eine neue Version von App ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem App-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (App.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: App unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "App enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "App-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für App ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie App auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob App dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von App anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von App automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von App.",
