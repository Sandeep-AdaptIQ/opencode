export const dict = {
  ...
  "dialog.provider.App.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.App.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.AppGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من App",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في App.",
  ...
  "provider.connect.AppZen.visit.prefix": "قم بزيارة ",
  "provider.connect.AppZen.visit.link": "#",
  "provider.connect.AppZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في App.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في App.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في App.json",
  ...
  "dialog.server.description": "تبديل خادم App الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingApp": "جارٍ التحقق من App...",
  "wsl.onboarding.checkingAppIn": "جارٍ التحقق من App في {{distro}}...",
  "wsl.onboarding.updatingApp": "جارٍ تحديث App...",
  "wsl.onboarding.updatingAppIn": "جارٍ تحديث App في {{distro}}...",
  "wsl.onboarding.updateAppIn": "حدّث App في {{distro}}.",
  "wsl.onboarding.updateApp": "تحديث App",
  "wsl.onboarding.AppReadyIn": "App جاهز في {{distro}}.",
  "wsl.onboarding.AppReady": "App جاهز.",
  "wsl.onboarding.installAppIn": "ثبّت App في {{distro}}.",
  "wsl.onboarding.installApp": "تثبيت App",
  ...
  "wsl.onboarding.distroStatus.AppMissing": "App غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن App من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على App التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح App.",
  ...
  "toast.update.description": "نسخة جديدة من App ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق App",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (App.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن App لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن App نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم App داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ App",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور App على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان App يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة App.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل App",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من App.",
